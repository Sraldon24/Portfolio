...
from main.models import HeroSlide, Profile
...
class DynamicBackgroundTest(TestCase):
    ...
    def test_image_background(self):
        ...
        self.profile.hero_static_image = SimpleUploadedFile(
            name="test_image.jpg", content=b"fakeimagecontent", content_type="image/jpeg"
        )
        self.profile.save()
    ...
    def test_video_background(self):
        ...
        self.profile.hero_video_file = SimpleUploadedFile(
            name="test.mp4", content=b"fakevideo", content_type="video/mp4"
        )
        self.profile.save()
